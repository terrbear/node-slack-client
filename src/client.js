...
Client = (function(_super) {
  ...
  Client.prototype.onMessage = function(message) {
    ...
    switch (message.type) {
      ...
      case 'pin_added':
        return this.emit('pin_added', message);
      case 'pin_removed':
        return this.emit('pin_removed', message);
      case 'file_created':
        return this.emit('file_created', message);
      case 'file_shared':
        return this.emit('file_shared', message);
      case 'file_deleted':
        return this.emit('file_deleted', message);
      default:
        if (message.reply_to) {
